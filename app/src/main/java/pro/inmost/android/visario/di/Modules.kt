...
import pro.inmost.android.visario.core.data.repositories.MessagesRepositoryImpl
...
import pro.inmost.android.visario.ui.screens.chats.ChatListAdapter
...
val viewModelsModule = module {
    ...
    viewModel { MessagesViewModel(get<MessagesRepositoryImpl>()) }
}

val repositories = module {
    single { AccountRepositoryImpl(get()) }
    single { ChatsRepositoryImpl(get()) }
    single { MessagesRepositoryImpl(get()) }
}